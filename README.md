...
3. When users click a product to buy, they are navigated to that shop's webpage but the exact product's page is shown "error 404/ not found". I think it might be the url is not being fetched properly, or the url being generated by the product name is not the same on the shop's website. Moreover, it creates problems when user asks AI to build the pc for them in pc builder as AI suggests parts that have outdated/previous prices.

4. None of the Products have relevant pictures. Will have to find a way to fetch the pictures too, from the shop websites.

5. Verification Email not working.

6. User can use the website without creating account.

7. Forget password when in the log in page.
...
5. Increase the amount of shops